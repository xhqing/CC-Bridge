...
- README 中英双语（README.md + README.zh-CN.md）+ LOGO + 徽章 + 版权署名：已就绪（2026-08-04 确认）

<!-- commit-skill: license = ok -->
- LICENSE.md：已存在，冗余的 LICENSE 已删除（2026-07-24 确认）

<!-- commit-skill: github-about = ok -->
- GitHub About：已配置（英文 description + topics，2026-07-24；2026-08-04 补中文描述）
...
- README 徽章：徽章组合合规（不含 Forks/Stars/Last Commit 动态徽章；2026-08-15 移除两版 last-commit 徽章后确认）

<!-- commit-skill: changelog-version = ok -->
- CHANGELOG.md 与 VERSION 文件：已存在（2026-08-04 确认）
